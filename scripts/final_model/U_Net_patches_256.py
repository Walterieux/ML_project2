...
from Post_Processing.create_submission_groundtruth import extract_test_images
...
def train_model(train_images, validation_images, test_images, train_labels, validation_labels, test_labels):
    ...
    patches.save_labels(unpatched_labels, "../../data/training_test/data_augmented_predicted_labels/")
...
def main():
    ...
    patches.save_labels(unpatched_labels, "../../data/test_set_labels/")
