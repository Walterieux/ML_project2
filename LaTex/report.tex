...
% TODO: list all stuff used for final model + how many epochs for good accuracy

\section{Results}
\label{sec:results}

% TODO: results -> we will not do direct comparisons because we did not have time to put together various, less good models, that use the same pre and post processing as our final model.
% TODO: accuracy w.r.t epochs -> GRAPH
...
% TODO: reminder of results, what we could add, what we learned, 


% TODO: cite and bibliography
\cite{anderson04}
